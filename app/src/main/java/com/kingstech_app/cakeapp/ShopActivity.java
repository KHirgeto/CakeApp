...
public class ShopActivity extends AppCompatActivity {
    ...
    private ArrayList<Cake>popularCake;
    private ShopAdapter mShopAdapter;
    private PopularShopAdapeter mShopAdapter2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager2 = findViewById(R.id.shopViewPager2);
    ...
    private void loadSpring() {
        ...
        springCakes.add(new Cake("UpsideDown Pineapple Cake","A basic single layer yellow butter cake inverted after baking to reveal a flavor infused glistening mosaic of caramelized canned pineapples.",25,R.drawable.upsidedowncake,2,R.drawable.upsidedown_t,4));
        springCakes.add(new Cake("Key Lime Pie","Cool zesty cream with sweet graham-cracker crust makes this semi-tart pie a winner. 9&quot Round - 16 Servings",20,R.drawable.keylimepie,1,R.drawable.keylimecake,4));
        springCakes.add(new Cake("Coconut Cake","Two layers of moist coconut flavored yellow cake filled with a sweetened coconut filling while covered with buttercream frosting and finely shredded coconut",30,R.drawable.cocunutcake,2,R.drawable.cctp,4));
        springCakes.add(new Cake("Strawberry Shortcake","An old-fashioned, two layers of tender shortcake, brusting with strawberries and topped with whipped cream",35,R.drawable.sshortcaketwo,1,R.drawable.sstp,4));
        springCakes.add(new Cake("5 Flavor Pound Cake","A simple yet rich, finely textured yellow cake with 5 distinct flavor cluminating in a one of a kind taste experience, topped with a butter glaze. (Flavor ingredients includes butter, vanilla, rum, almond, and coconut)",25,R.drawable.poundcake,2,R.drawable.fvtp,4));
...
//        fallCakes.add(new Cake("Bacardi Rum Cake","",30,R.drawable.bascardirumcake,1));
    ...
    {
        popularCake = new ArrayList<Cake>();
        ...
        popularCake.add(new Cake("Banana Cake","Don't let this bread's simple flavor fool you. Our Banana bread's moist texture will have your mouth watering.",15,R.drawable.bananacake,1,R.drawable.bntbone,4));
        mShopAdapter2 = new PopularShopAdapeter(this,popularCake);
        mViewPager2.setAdapter(mShopAdapter2);
        mViewPager2.setPadding(200,0,200,0);
    }
}